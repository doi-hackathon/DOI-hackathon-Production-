...
public class UserController {
    ...
    public UserController(UsersRepository usersDao, PasswordEncoder passwordEncoder, SubmissionsRepository submissionsDao, UserService userService) {
...
//        user.setPasswordToConfirm(hashForConfirm);
    ...
    public String showUserDashboard(Model model){
        ...
        model.addAttribute("judgesSubmissions", submissionsDao.findSubmissionsByJudges(currentUser));
